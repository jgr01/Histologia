...
<html>
    ...
    <body>
        <div class="container">
            ...
            <h1><p>Arrastrar y Soltar</p></h1><br>
            <div class="row">
                ...
                <div class="col-md-4 col-lg-4 col-xs-4 col-sm-4" align = "center">
                    <div class="drop1" id="drop3" style="background:url('img/imagen0020.jpg')"></div><br>
                    <div class="drop1" id="drop2">2</div><br>
                    <div class="drop1" id="drop1">1</div><br>
                    <div class="drop1" id="drop4">4</div><br>
                </div>
